...
function Footer() {
  return (
    <footer className="w-full flex gap-[20px] justify-center text-[#323232] font-pretendard xl:text-xs lg:text-xs md:text-xs sm:text-[8px] xs:text-[8px] font-normal leading-[150%] underline xl:mt-[245px] lg:mt-[136.81px] md:mt-[136.81px]  mb-10">
