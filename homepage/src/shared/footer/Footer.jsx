...
function Footer() {
  return (
    <section className="w-full flex gap-[20px] justify-center text-[#323232] font-pretendard text-xs font-normal leading-[150%] underline xl:mt-[245px] lg:mt-[136.81px] md:mt-[136.81px]  mb-10">
