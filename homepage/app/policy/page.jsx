    ...
    return (
        <main>
            <article>
                ...
                <section>
                    <h2>2. 개인정보 수집</h2>
                    <h3>서비스 제공을 위한 필요 최소한의 개인정보를 수집합니다.</h3>
                    <p>
                    ...
                    <p>
                        ...
                        결제 내역
                        <br />
                        [선택] 생년월일, 성별, 배송지정보(수령인명, 배송지주소, 전화번호)
                    </p>
                    <p>
                        [고객상담 시]
                        <br />
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>이용자간 팔로우 및 추천 기능의 제공</li>
                        <li>팔로워에게 활동내역을 알리거나 이용자 검색, 등록 등의 기능 제공</li>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>권리침해 신고 및 유해정보 신고 이력은 5년간 보관 후 파기합니다.</li>
                    </ul>
                    <p>이 외에 법령에 따라 개인정보를 처리합니다.</p>
                    <div className="info-card">
                        <figure>
                            <Image src="/images/보유기간.png" alt="보유기간 및 파기" width={64} height={64} />
                            <figcaption>보유기간 및 파기</figcaption>
                        </figure>
                        <p>
                ...
                <section>
                    ...
                    <p>
                        ...
                        처리합니다.
                        <br />
                        링크드아웃 위치정보 이용약관 제4조에 따른 서비스의 제공을 위해 개인위치정보를 보유할 수
                        있습니다.
                    </p>
                    <ul>
                    ...
                    <p>개인위치정보의 수집 및 이용목적이 달성되면 지체없이 파기합니다.</p>
                    <p>
                    ...
                    <p>이용자의 사전 동의 없이 개인위치정보를 제3자에게 제공하지 않습니다.</p>
                    <p>
                    ...
                    <p>8세 이하의 아동 등의 보호를 위해 필요한 경우 보호의무자의 권리는 아래와 같습니다.</p>
                    <p>
                        위치정보법 제26조제1항에 따라 '8세 이하의 아동', '피성년후견인', '장애인복지법에 따른 장애인에
                        해당하는 이용자'의 생명 또는 신체 보호를 위하여 보호의무자가 개인위치정보의 이용 또는 제공에
                        동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.
                        <br />위 권리를 행사하고자 하는 보호의무자는 서면동의서에 보호의무자임을 증명하는 서면을
                        첨부하여 회사에 제출하여야 하며, 이 경우 보호의무자는 위치정보 이용약관에 따른 이용자의 권리를
                        모두 가집니다.
                        <br />그 외 개인위치정보 처리와 관련된 자세한 내용은 링키드아웃 위치정보 이용약관을 참고하시기
                        바랍니다.
                    </p>
                    <div className="info-card">
                        <figure>
                            <Image src="/images/위치정보.png" alt="보유기간 및 파기" width={64} height={64} />
                            <figcaption>보유기간 및 파기</figcaption>
                        </figure>
                        <p>
                            수집 및 이용 목적의 달성 또는 회원 탈퇴 등 파기사유가 발생한 개인정보는 안전하게 파기합니다.
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>
                                    엣지(Edge): 웹 브루아저 설정 &gt; 쿠키 및 사이트 권한 &gt; 쿠키 및 사이트 데이터
                                    관리 및 삭제
                                </li>
                            </ul>
                            <p>모바일브라우저에서 쿠키 허용/차단</p>
                            <ul>
                                <li>
                ...
                <section>
                    <h2>9. 개인정보의 안전성 확보 조치에 관한 사항</h2>
                    ...
                    <div>
                        <figure>
                            ...
                            <figcaption>안전성 확보조치</figcaption>
                        </figure>
                        <p>
                    ...
                    <p>유렵연합 내 이용자를 대상으로 서비스를 제공하는 경우, 아래 내용이 적용될 수 있습니다.</p>
                    ...
                    <div>
                        <figure>
                            <Image
                                ...
                                height={64}
                            />
                            <figcaption>개인정보보호책임자 & 고충처리 부서</figcaption>
                        </figure>
                        <figcaption>
                            링크드아웃 서비스 이용 시 발생하는 모든 개인정보보호 관련 문의 및 불만사항은
                            개인정보보호책임자 고충처리 부서(링크드아웃 고객센터)로 문의해주시면 됩니다.
                        </figcaption>
                    </div>
                </section>
            </article>
